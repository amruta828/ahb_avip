`ifndef AHBVIRTUALLENGTH16WRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_
`define AHBVIRTUALLENGTH16WRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_
 
class AhbVirtualLength16WriteFollowedByReadSequence extends AhbVirtualBaseSequence;
  `uvm_object_utils(AhbVirtualLength16WriteFollowedByReadSequence)
  ...
  extern function new(string name ="AhbVirtualLength16WriteFollowedByReadSequence");
  extern task body();
 
endclass : AhbVirtualLength16WriteFollowedByReadSequence
 
function AhbVirtualLength16WriteFollowedByReadSequence::new(string name ="AhbVirtualLength16WriteFollowedByReadSequence");
  super.new(name);
endfunction : new
 
task AhbVirtualLength16WriteFollowedByReadSequence::body();
  super.body();
