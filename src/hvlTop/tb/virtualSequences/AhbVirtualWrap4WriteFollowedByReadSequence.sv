`ifndef AHBVIRTUALWRAP4WRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_
`define AHBVIRTUALWRAP4WRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_

class AhbVirtualWrap4WriteFollowedByReadSequence extends AhbVirtualBaseSequence;
  `uvm_object_utils(AhbVirtualWrap4WriteFollowedByReadSequence)
  ...
  extern function new(string name ="AhbVirtualWrap4WriteFollowedByReadSequence");
  extern task body();

endclass : AhbVirtualWrap4WriteFollowedByReadSequence

function AhbVirtualWrap4WriteFollowedByReadSequence::new(string name ="AhbVirtualWrap4WriteFollowedByReadSequence");
  super.new(name);
endfunction : new

task AhbVirtualWrap4WriteFollowedByReadSequence::body();
  super.body();
