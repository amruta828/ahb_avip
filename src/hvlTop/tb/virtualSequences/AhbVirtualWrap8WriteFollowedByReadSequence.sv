`ifndef AHBVIRTUALWRAP8WRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_
`define AHBVIRTUALWRAP8WRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_

class AhbVirtualWrap8WriteFollowedByReadSequence extends AhbVirtualBaseSequence;
  `uvm_object_utils(AhbVirtualWrap8WriteFollowedByReadSequence)
  ...
  extern function new(string name ="AhbVirtualWrap8WriteFollowedByReadSequence");
  extern task body();

endclass : AhbVirtualWrap8WriteFollowedByReadSequence

function AhbVirtualWrap8WriteFollowedByReadSequence::new(string name ="AhbVirtualWrap8WriteFollowedByReadSequence");
  super.new(name);
endfunction : new

task AhbVirtualWrap8WriteFollowedByReadSequence::body();
  super.body();
